...
import { Plus, Edit2, Eye, Trash2, MapPin } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import Button from '../../components/ui/Button';
import Progress from '../../components/ui/Progress';
import { MOCK_CAMPAIGNS, formatCurrency, progressPercent, statusColor, categoryColor } from '../../lib/utils';
...
export default function MyCampaigns() {
  ...
  const campaigns = MOCK_CAMPAIGNS.slice(0, 5);
        ...
        {campaigns.map((c) => {
          ...
          return (
            <div key={c._id} className="card flex flex-col overflow-hidden">
              {/* Image */}
              <div className="h-36 bg-brand-100 overflow-hidden relative">
                {c.coverImage ? (
              ...
              <div className="p-4 flex flex-col gap-3 flex-1">
                <h3 className="font-semibold text-sm text-[#1a1a2e] line-clamp-2">{c.title}</h3>
